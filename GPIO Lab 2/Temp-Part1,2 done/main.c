...
int main(void) {
  ...
  xTaskCreate(led_task, "led2", 4096 / sizeof(void *), &led2, PRIORITY_LOW, NULL);
  xTaskCreate(led_task, "led3", 4096 / sizeof(void *), &led3, PRIORITY_LOW, NULL);
